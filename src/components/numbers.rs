...
(value: T, label: &'static str, min: T, max: T, step: T, on_change: EventHandler<String>) -> Element {
    rsx!{
        div{
            class: "w-full text-slate-200 my-8 text-center bg-transparent border border-slate-700 has-[:focus]:border-blue-500 focus:border-blue-500 hover:border-blue-500",
            input{
                r#type: "number",
